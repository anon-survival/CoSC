...
from SurvivalEVAL.utils.util_survival import xcal_from_hist

from SurvivalEVAL.Evaluations.D_Calibration import d_cal, create_censor_binning
    ...
    if conditions:
        ...
        for condition in conditions:
            ...
            if idx.mean() < delta:
                ...
                _, dcal_hist = d_cal(predict_probs[idx], event_indicators[idx], num_bins)
...
def sample_sphere(n, p, random_state=42):
